...
# Test the MAC algorithm with a Sudoku puzzle
sudoku = generate_sudoku.generate_sudoku()



if mac(sudoku):
    print("The Sudoku puzzle is consistent and has been solved:")
else:
    print("The Sudoku puzzle is not consistent and cannot be solved:")
for row in sudoku:
    print(row)
